...
public class CardVisual : MonoBehaviour
{
    ...
    [Header("CardInfo")] [SerializeField] private TMP_Text titleText;
    ...
    {
        remainLifeText.text =
            $"<size=80%>{parentCard.runtimeData.remainingLife}</size><color=red><voffset=10>-{(int)(decrease * parentCard.runtimeData.data.decrease)}</voffset></color>";
    }
